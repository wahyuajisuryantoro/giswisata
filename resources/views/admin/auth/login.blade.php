    ...
    <div id="auth">
        <div class="container">
            <div class="row justify-content-center align-items-center" style="height: 100vh;">
                <div class="col-md-5">
                    <div id="auth-left" class="card shadow-sm" style="border-radius: 15px;">
                        <div class="card-body">
                            <div class="auth-logo mb-4 ml-2">
                                <a href="{{ route('index') }}" class="d-flex align-items-center">
                                    <i class="bi bi-chevron-left"></i>
                                    <span class="ms-1 mt-2">Kembali ke Website</span>
                                </a>
                            </div>                            
                            <h1 class="auth-title text-center fs-4">Login</h1>
